...
const brands: Record<string, ProviderBrand> = {
  ...
  "Iuvo Group": defineBrand("IV", "#1266CC", "#FFFFFF", "https://iuvo-group.com"),
  Trezor: defineBrand("TZ", "#0F172A", "#FFFFFF", "https://trezor.io"),
  Linxea: defineBrand("LX", "#0E7C66", "#FFFFFF", "https://www.linxea.com"),
