...
const dictionaries: Record<MarketplaceLocale, Dictionary> = {
  en: {
    ...
    offerDetail: {
      ...
      primaryAction: "",
      primaryActionBody: "We'll send you straight to {provider} when you're ready.",
      ratesTitle: "Pricing & terms",
      benefitsTitle: "What you get",
      tradeoffsTitle: "Things to watch",
    ...
    sidebarNav: {
      ...
      // breadcrumbs. Keys preserved for i18n stability; display strings
      // tightened to single-word pillar names per the spec.
      groupBankingCards: "Spend",
      groupSendExchange: "Move",
      groupBorrowPayLater: "Borrow",
      groupInvestTrade: "Save",
      groupProtectLifestyle: "Protect",
  ...
  de: {
    ...
    offerDetail: {
      ...
      primaryAction: "",
      primaryActionBody: "Wir leiten Sie direkt zu {provider} weiter, wenn Sie bereit sind.",
      ratesTitle: "Preise & Konditionen",
      benefitsTitle: "Das bekommen Sie",
      tradeoffsTitle: "Worauf zu achten ist",
    ...
    sidebarNav: {
      ...
      groupSendExchange: "Senden",
      groupBorrowPayLater: "Leihen",
      groupInvestTrade: "Sparen",
      groupProtectLifestyle: "Schützen",
  ...
  es: {
    ...
    offerDetail: {
      ...
      primaryAction: "",
      primaryActionBody: "Te enviaremos directo a {provider} cuando estés listo.",
      ratesTitle: "Precios y condiciones",
      benefitsTitle: "Lo que obtienes",
      tradeoffsTitle: "Cosas a tener en cuenta",
    ...
    sidebarNav: {
      ...
      groupSendExchange: "Mover",
      groupBorrowPayLater: "Pedir prestado",
      groupInvestTrade: "Ahorrar",
      groupProtectLifestyle: "Proteger",
  ...
  fr: {
    ...
    sidebarNav: {
      ...
      groupSendExchange: "Envoyer",
      groupBorrowPayLater: "Emprunter",
      groupInvestTrade: "Épargner",
      groupProtectLifestyle: "Protéger",
  ...
  it: {
    ...
    offerDetail: {
      ...
      ratesTitle: "Tariffe e condizioni",
    ...
    sidebarNav: {
      ...
      groupSendExchange: "Inviare",
      groupBorrowPayLater: "Prendere in prestito",
      groupInvestTrade: "Risparmiare",
      groupProtectLifestyle: "Proteggere",
      groupBusiness: "Business",
  ...
  pt: {
    ...
    offerDetail: {
      ...
      ratesTitle: "Preços e condições",
      benefitsTitle: "O que recebe",
    ...
    sidebarNav: {
      groupBankingCards: "Gastar",
      groupSendExchange: "Enviar",
      groupBorrowPayLater: "Pedir emprestado",
      groupInvestTrade: "Poupar",
      groupProtectLifestyle: "Proteger",
