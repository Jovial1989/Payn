...
const dictionaries: Record<MarketplaceLocale, Dictionary> = {
  en: {
    ...
    offerCard: {
      ...
      providerCta: {
        ...
        crypto: "Open provider",
        business: "Open provider",
    ...
    homeAtlas: {
      ...
      bucketSpendSmarter: { title: "Cards", description: "Debit, credit, cashback & rewards" },
      bucketEarnOnCash: { title: "Savings & Deposits", description: "High-interest savings & term deposits" },
      bucketTravel: { title: "Transfers & Exchange", description: "International transfers, FX, remittance, travel cards" },
  ...
  de: {
    ...
    homeAtlas: {
      ...
      bucketSpendSmarter: { title: "Karten", description: "Debit-, Kredit-, Cashback-Karten & Prämien" },
      bucketEarnOnCash: { title: "Sparen & Festgeld", description: "Hochzins-Sparkonten & Festgeld" },
      bucketTravel: { title: "Überweisung & FX", description: "Auslandsüberweisungen, FX, Remittance, Travel-Karten" },
  ...
  es: {
    ...
    homeAtlas: {
      ...
      bucketSpendSmarter: { title: "Tarjetas", description: "Débito, crédito, cashback y recompensas" },
      bucketEarnOnCash: { title: "Ahorros y depósitos", description: "Cuentas de alto interés y depósitos a plazo" },
      bucketTravel: { title: "Transferencias y FX", description: "Transferencias internacionales, FX, remesas, tarjetas de viaje" },
  ...
  fr: {
    ...
    homeAtlas: {
      ...
      bucketSpendSmarter: { title: "Cartes", description: "Cartes débit, crédit, cashback et récompenses" },
      bucketEarnOnCash: { title: "Épargne & dépôts", description: "Épargne à haut rendement et dépôts à terme" },
      bucketTravel: { title: "Virements & FX", description: "Virements internationaux, change, remittance, cartes voyage" },
  ...
  it: {
    ...
    homeAtlas: {
      ...
      bucketSpendSmarter: { title: "Carte", description: "Carte di debito, credito, cashback e premi" },
      bucketEarnOnCash: { title: "Risparmi & depositi", description: "Risparmi ad alto interesse e depositi a termine" },
      bucketTravel: { title: "Trasferimenti & FX", description: "Trasferimenti internazionali, cambio, remittance, carte di viaggio" },
  ...
  pt: {
    ...
    homeAtlas: {
      ...
      bucketSpendSmarter: { title: "Cartões", description: "Débito, crédito, cashback e recompensas" },
      bucketEarnOnCash: { title: "Poupança & depósitos", description: "Poupanças de juro alto e depósitos a prazo" },
      bucketTravel: { title: "Transferências & FX", description: "Transferências internacionais, câmbio, remessas, cartões de viagem" },
