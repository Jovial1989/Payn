  ...
  en: {
    ...
    dashboard: {
      ...
      navItems: {
        ...
        explore: { label: "Explore", description: "Browse and filter offers" },
        ...
        profile: { label: "Profile", description: "Preferences and setup" },
      },
      shellTag: "Product",
      ...
      noSavedDescription: "Save products from Explore to build your shortlist.",
  ...
  de: {
    ...
    dashboard: {
      ...
      navItems: {
        ...
        explore: { label: "Entdecken", description: "Angebote durchsuchen und filtern" },
        ...
        profile: { label: "Profil", description: "Präferenzen und Setup" },
      },
      shellTag: "Produkt",
  ...
  es: {
    ...
    dashboard: {
      ...
      navItems: {
        ...
        explore: { label: "Explorar", description: "Navegar y filtrar ofertas" },
        ...
        profile: { label: "Perfil", description: "Preferencias y configuración" },
      },
      shellTag: "Producto",
  ...
  fr: {
    ...
    dashboard: {
      ...
      navItems: {
        ...
        explore: { label: "Explorer", description: "Parcourir et filtrer les offres" },
        ...
        profile: { label: "Profil", description: "Préférences et configuration" },
      },
      shellTag: "Produit",
  ...
  it: {
    ...
    dashboard: {
      ...
      navItems: {
        ...
        explore: { label: "Esplora", description: "Sfoglia e filtra le offerte" },
        ...
        profile: { label: "Profilo", description: "Preferenze e configurazione" },
      },
      shellTag: "Prodotto",
  ...
  pt: {
    ...
    dashboard: {
      ...
      navItems: {
        ...
        explore: { label: "Explorar", description: "Navegar e filtrar ofertas" },
        ...
        profile: { label: "Perfil", description: "Preferências e configuração" },
      },
      shellTag: "Produto",
