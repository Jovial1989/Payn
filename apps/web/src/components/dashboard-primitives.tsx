...
export function DashboardSectionCard({
  ...
  return (
    <section className="motion-section relative overflow-hidden rounded-[32px] border border-line bg-white p-6 shadow-card sm:p-8">
...
export function DashboardEmptyState({
  ...
  return (
    <div className="rounded-[24px] border border-dashed border-line bg-bg-surface p-6">
...
export function DashboardLoadingState({ label }: { label: string }) {
  return (
    <div className="relative overflow-hidden rounded-[32px] border border-line bg-white p-10 shadow-card">
      <div className="grid gap-4 py-4">
        <div className="h-5 w-32 animate-pulse rounded-full bg-bg-surface" />
        <div className="grid gap-4 rounded-[24px] border border-line bg-bg-surface p-6">
          <div className="h-10 w-full animate-pulse rounded-[18px] bg-line" />
          <div className="grid gap-3 md:grid-cols-2">
            <div className="h-24 animate-pulse rounded-[20px] bg-line" />
            <div className="h-24 animate-pulse rounded-[20px] bg-line" />
          </div>
        </div>
...
export function DashboardMetricCard({
  ...
  return (
    <div className="rounded-[24px] border border-line bg-white px-5 py-4 shadow-card">
...
export function DashboardContextPill({ children }: { children: ReactNode }) {
  return (
    <span className="rounded-full border border-line bg-bg-surface px-3 py-1.5 text-xs font-semibold leading-none text-ink-secondary whitespace-nowrap">
      {children}
    </span>
  );
}
